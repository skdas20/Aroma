...
// Removed TimeSlot interface and related UI/state
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-center mt-4">
            <div className="flex space-x-8 md:space-x-20 text-xs md:text-sm text-primary-600">
              ...
              <span className={step >= 2 ? 'text-golden-600 font-semibold' : ''}>Payment</span>
              <span className={step >= 3 ? 'text-golden-600 font-semibold' : ''}>Done</span>
            </div>
          </div>
        </div>
